<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show {{ request()->routeIs('app.pos.*') ? 'c-sidebar-minimized' : '' }}" id="sidebar">
    <div class="c-sidebar-brand d-md-down-none">
        <a href="{{ route('home') }}">
            <img class="c-sidebar-brand-full" src="{{ asset('images/Logo_SyncroPOS.png') }}" alt="Site Logo" width="165">
            <img class="c-sidebar-brand-minimized" src="{{ asset('images/Logo_SyncroPOS (1).png') }}" alt="Site Logo" width="38">
        </a>
    </div>
